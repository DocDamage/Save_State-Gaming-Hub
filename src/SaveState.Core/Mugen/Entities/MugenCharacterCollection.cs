...
/// </summary>
public class MugenCharacterCollection : EntityBase
{
    /// <summary>
    ...
    /// <returns>A new MugenCharacterCollection instance.</returns>
    public static MugenCharacterCollection Create(
        string name,
        Guid userId,
        ...
        bool isPublic = false)
    {
        return new MugenCharacterCollection
        {
            Id = Guid.NewGuid(),
    ...
    // EF Core constructor
    private MugenCharacterCollection() { }
}