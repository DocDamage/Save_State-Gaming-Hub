...
/// <summary>
/// Heuristic for detecting crouch state values in game memory.
/// IsCrouching values typically:
/// - Are boolean values (0 or 1)
/// - 1 when crouching, 0 when standing
/// - Changes with crouch input toggle or hold
/// - Often toggled rather than held
/// </summary>
public sealed class IsCrouchingHeuristic : IValueHeuristic
{
    public string Name => "Crouch State Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Crouch can be held for extended periods
        if (maxContinuousOnes >= 3)
        {
            score += 0.15;
        }
