...
/// <summary>
/// Heuristic for detecting active waypoint Y (or Z in some engines) coordinate.
/// Active Waypoint Y values typically:
/// - Are floats representing target Y position
/// - Change when setting new waypoints
/// - Often constant between waypoint changes
/// </summary>
public sealed class ActiveWaypointYHeuristic : IValueHeuristic
{
    public string Name => "Active Waypoint Y Coordinate Detection";
