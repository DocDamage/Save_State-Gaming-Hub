...
/// <summary>
/// Heuristic for detecting world X coordinate in 3D games.
/// World X values typically:
/// - Are floats representing horizontal position
/// - Change gradually as player moves
/// - Can be positive or negative depending on world origin
/// </summary>
public sealed class WorldXHeuristic : IValueHeuristic
{
    public string Name => "World X Coordinate Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        for (int i = 1; i < history.Count; i++)
        {
            ...
            // Large jumps are suspicious (teleports OK, but should be rare)
            if (delta > 1000)
            {
                score -= 0.2;
            }

            // Negative values are valid for world coords
