...
/// <summary>
/// Heuristic for detecting region/map section Y coordinate.
/// Region Y values typically:
/// - Are integers representing large map region row index
/// - Change infrequently when entering new zones
/// - Complement RegionX for 2D region grid
/// </summary>
public sealed class RegionYHeuristic : IValueHeuristic
{
    public string Name => "Region Y Coordinate Detection";
