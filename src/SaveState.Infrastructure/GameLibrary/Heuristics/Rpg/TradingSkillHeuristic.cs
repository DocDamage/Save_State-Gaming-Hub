...
/// <summary>
/// Heuristic for detecting trading/bartering skill levels in RPG games.
/// Trading skill values typically:
/// - Are integers in range 0-100
/// - Increase through trading activities
/// - Affect buy/sell prices
/// </summary>
public sealed class TradingSkillHeuristic : IValueHeuristic
{
    public string Name => "Trading Skill Detection";
