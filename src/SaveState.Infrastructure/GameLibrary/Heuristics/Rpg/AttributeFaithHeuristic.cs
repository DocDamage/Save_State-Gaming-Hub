...
/// <summary>
/// Heuristic for detecting faith attribute in RPG games.
/// Faith values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect divine magic power and miracle effectiveness
/// </summary>
public sealed class AttributeFaithHeuristic : IValueHeuristic
{
    public string Name => "Faith Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (faith typically 1-999)
