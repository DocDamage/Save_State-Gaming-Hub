...
/// <summary>
/// Heuristic for detecting wisdom attribute in RPG games.
/// Wisdom values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect mana pool and magical perception
/// </summary>
public sealed class AttributeWisdomHeuristic : IValueHeuristic
{
    public string Name => "Wisdom Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (wisdom typically 1-999)
