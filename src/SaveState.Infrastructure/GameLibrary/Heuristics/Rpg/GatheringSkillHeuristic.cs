...
/// <summary>
/// Heuristic for detecting gathering skill levels in RPG games.
/// Gathering skill values typically:
/// - Are integers in range 0-300 (mining, herbalism, fishing, etc.)
/// - Increase when gathering resources
/// - Decay rarely or never
/// </summary>
public sealed class GatheringSkillHeuristic : IValueHeuristic
{
    public string Name => "Gathering Skill Detection";
