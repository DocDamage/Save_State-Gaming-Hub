...
/// <summary>
/// Heuristic for detecting speed attribute in RPG games.
/// Speed values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect movement speed and action points
/// </summary>
public sealed class AttributeSpeedHeuristic : IValueHeuristic
{
    public string Name => "Speed Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (speed typically 1-999)
