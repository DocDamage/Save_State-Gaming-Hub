...
/// <summary>
/// Heuristic for detecting physical resistance in RPG games.
/// Physical resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with armor or gear
/// - Reduces damage from physical attacks
/// </summary>
public sealed class ResistPhysicalHeuristic : IValueHeuristic
{
    public string Name => "Physical Resistance Detection";
