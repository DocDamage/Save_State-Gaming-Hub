...
/// <summary>
/// Heuristic for detecting dexterity attribute in RPG games.
/// Dexterity values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect ranged damage, accuracy, and evasion
/// </summary>
public sealed class AttributeDexterityHeuristic : IValueHeuristic
{
    public string Name => "Dexterity Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (dexterity typically 1-999)
