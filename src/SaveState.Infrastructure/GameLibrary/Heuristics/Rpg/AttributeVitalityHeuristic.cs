...
/// <summary>
/// Heuristic for detecting vitality/constitution attribute in RPG games.
/// Vitality values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect health and stamina
/// </summary>
public sealed class AttributeVitalityHeuristic : IValueHeuristic
{
    public string Name => "Vitality/Constitution Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (vitality typically 1-999)
