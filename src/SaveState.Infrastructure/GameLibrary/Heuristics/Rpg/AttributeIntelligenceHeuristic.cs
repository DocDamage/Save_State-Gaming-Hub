...
/// <summary>
/// Heuristic for detecting intelligence/magic attribute in RPG games.
/// Intelligence values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect mana and spell damage
/// </summary>
public sealed class AttributeIntelligenceHeuristic : IValueHeuristic
{
    public string Name => "Intelligence/Magic Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (intelligence typically 1-999)
