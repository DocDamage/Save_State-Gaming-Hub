...
/// <summary>
/// Heuristic for detecting luck attribute in RPG games.
/// Luck values typically:
/// - Are integers (1-999)
/// - Increase with level-ups or special items
/// - Affect drop rates and criticals
/// </summary>
public sealed class LuckHeuristic : IValueHeuristic
{
    public string Name => "Luck Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (luck typically 1-999)
