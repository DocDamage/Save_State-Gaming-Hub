...
/// <summary>
/// Heuristic for detecting holy/light resistance in RPG games.
/// Holy resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear or holy-related buffs
/// - Common in games with divine/light magic systems
/// </summary>
public sealed class ResistHolyHeuristic : IValueHeuristic
{
    public string Name => "Holy Resistance Detection";
