...
/// <summary>
/// Heuristic for detecting fire resistance in RPG games.
/// Fire resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear
/// - Common element in fantasy RPGs
/// </summary>
public sealed class ResistFireHeuristic : IValueHeuristic
{
    public string Name => "Fire Resistance Detection";
