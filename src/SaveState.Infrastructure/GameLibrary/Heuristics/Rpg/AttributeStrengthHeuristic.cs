...
/// <summary>
/// Heuristic for detecting strength attribute in RPG games.
/// Strength values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect melee damage
/// </summary>
public sealed class AttributeStrengthHeuristic : IValueHeuristic
{
    public string Name => "Strength Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (strength typically 1-999)
