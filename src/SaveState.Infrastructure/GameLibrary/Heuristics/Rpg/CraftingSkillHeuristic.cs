...
/// <summary>
/// Heuristic for detecting crafting skill levels in RPG games.
/// Crafting skill values typically:
/// - Are integers in range 0-300 (or 0-100 for capped systems)
/// - Increase when crafting items
/// - Decay rarely or never
/// </summary>
public sealed class CraftingSkillHeuristic : IValueHeuristic
{
    public string Name => "Crafting Skill Detection";
