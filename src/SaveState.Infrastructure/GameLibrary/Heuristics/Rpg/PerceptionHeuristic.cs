...
/// <summary>
/// Heuristic for detecting perception/wisdom attribute in RPG games.
/// Perception values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect detection and spotting secrets
/// </summary>
public sealed class PerceptionHeuristic : IValueHeuristic
{
    public string Name => "Perception/Wisdom Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (perception typically 1-999)
