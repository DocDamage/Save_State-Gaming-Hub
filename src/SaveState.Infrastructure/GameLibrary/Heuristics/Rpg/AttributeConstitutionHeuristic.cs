...
/// <summary>
/// Heuristic for detecting constitution attribute in RPG games.
/// Constitution values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect maximum health and physical resistance
/// </summary>
public sealed class AttributeConstitutionHeuristic : IValueHeuristic
{
    public string Name => "Constitution Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (constitution typically 1-999)
