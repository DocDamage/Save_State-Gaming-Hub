...
/// <summary>
/// Heuristic for detecting willpower attribute in RPG games.
/// Willpower values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect magic resistance and mental fortitude
/// </summary>
public sealed class AttributeWillpowerHeuristic : IValueHeuristic
{
    public string Name => "Willpower Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (willpower typically 1-999)
