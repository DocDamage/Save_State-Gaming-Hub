...
/// <summary>
/// Heuristic for detecting poison resistance in RPG games.
/// Poison resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear
/// - Common in survival and fantasy RPGs
/// </summary>
public sealed class ResistPoisonHeuristic : IValueHeuristic
{
    public string Name => "Poison Resistance Detection";
