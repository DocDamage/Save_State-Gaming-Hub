...
/// <summary>
/// Heuristic for detecting magic resistance in RPG games.
/// Magic resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear or buffs
/// - Common defensive stat in fantasy RPGs
/// </summary>
public sealed class ResistMagicHeuristic : IValueHeuristic
{
    public string Name => "Magic Resistance Detection";
