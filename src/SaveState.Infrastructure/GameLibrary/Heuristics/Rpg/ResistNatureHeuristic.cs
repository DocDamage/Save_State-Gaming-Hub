...
/// <summary>
/// Heuristic for detecting nature/earth resistance in RPG games.
/// Nature resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear or nature-related buffs
/// - Common in druidic or nature-themed RPGs
/// </summary>
public sealed class ResistNatureHeuristic : IValueHeuristic
{
    public string Name => "Nature Resistance Detection";
