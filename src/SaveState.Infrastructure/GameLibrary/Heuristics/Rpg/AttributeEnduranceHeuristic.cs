...
/// <summary>
/// Heuristic for detecting endurance attribute in RPG games.
/// Endurance values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect stamina and health regeneration
/// </summary>
public sealed class AttributeEnduranceHeuristic : IValueHeuristic
{
    public string Name => "Endurance Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (endurance typically 1-999)
