...
/// <summary>
/// Heuristic for detecting lightning/electric resistance in RPG games.
/// Lightning resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear
/// - Common element in fantasy RPGs
/// </summary>
public sealed class ResistLightningHeuristic : IValueHeuristic
{
    public string Name => "Lightning/Electric Resistance Detection";
