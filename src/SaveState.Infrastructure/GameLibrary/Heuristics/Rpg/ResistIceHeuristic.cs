...
/// <summary>
/// Heuristic for detecting ice/cold resistance in RPG games.
/// Ice resist values typically:
/// - Are integers or floats (0-100) representing percentage
/// - Relatively stable, change with gear
/// - Common element in fantasy RPGs
/// </summary>
public sealed class ResistIceHeuristic : IValueHeuristic
{
    public string Name => "Ice/Cold Resistance Detection";
