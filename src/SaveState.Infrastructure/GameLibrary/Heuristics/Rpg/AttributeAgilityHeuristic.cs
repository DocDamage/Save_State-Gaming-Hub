...
/// <summary>
/// Heuristic for detecting agility/dexterity attribute in RPG games.
/// Agility values typically:
/// - Are integers (1-999)
/// - Increase with level-ups
/// - Affect speed and crit chance
/// </summary>
public sealed class AttributeAgilityHeuristic : IValueHeuristic
{
    public string Name => "Agility/Dexterity Attribute Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range (agility typically 1-999)
