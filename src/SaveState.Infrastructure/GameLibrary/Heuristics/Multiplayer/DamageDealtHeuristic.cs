...
/// <summary>
/// Heuristic for detecting damage dealt in multiplayer games.
/// Damage dealt values typically:
/// - Are integers (0-999999)
/// - Only increase during match
/// - Vary by weapon and hit location
/// - Reset between matches
/// </summary>
public sealed class DamageDealtHeuristic : IValueHeuristic
{
    public string Name => "Damage Dealt Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        for (int i = 1; i < history.Count; i++)
        {
            ...
            if (currVal > prevVal)
            {
                ...
                // Damage varies by hit (5-200 typically)
