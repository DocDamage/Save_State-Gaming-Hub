...
/// <summary>
/// Heuristic for detecting damage reflection values in game memory.
/// Damage reflection values typically:
...
/// - Often found on defensive gear
/// </summary>
public sealed class DamageReflectionHeuristic : IValueHeuristic
{
    public string Name => "Damage Reflection Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Check value range
        if (IsInReflectionRange(value.CurrentValue))
        {
            score += 0.4;
        }
        ...
        // Damage reflection should be relatively static
        if (history.Count > 1)
        {
    ...
    private static bool IsInReflectionRange(object? value)
    {
