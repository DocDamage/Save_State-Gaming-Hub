...
/// <summary>
/// Heuristic for detecting stun chance values in game memory.
/// Stun chance values typically:
/// - Are floats in range 0.0-100.0 (percentage)
/// - Static or change with gear/skill upgrades
/// - Often associated with crowd control effects
/// - May trigger on successful attacks
/// </summary>
public sealed class StunChanceHeuristic : IValueHeuristic
{
    public string Name => "Stun Chance Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Stun chance should be relatively static
        if (history.Count > 1)
        {
