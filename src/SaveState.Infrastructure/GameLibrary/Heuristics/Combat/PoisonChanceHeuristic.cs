...
/// <summary>
/// Heuristic for detecting poison chance values in game memory.
/// Poison chance values typically:
/// - Are floats in range 0.0-100.0 (percentage)
/// - Static or change with gear/skill upgrades
/// - Often associated with toxic/nature damage
/// - May trigger on successful attacks with poisoned weapons
/// </summary>
public sealed class PoisonChanceHeuristic : IValueHeuristic
{
    public string Name => "Poison Chance Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Poison chance should be relatively static
        if (history.Count > 1)
        {
