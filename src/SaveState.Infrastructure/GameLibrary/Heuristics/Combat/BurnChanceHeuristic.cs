...
/// <summary>
/// Heuristic for detecting burn chance values in game memory.
/// Burn chance values typically:
/// - Are floats in range 0.0-100.0 (percentage)
/// - Static or change with gear/skill upgrades
/// - Often associated with fire/heat elemental effects
/// - May trigger on successful attacks with fire weapons
/// </summary>
public sealed class BurnChanceHeuristic : IValueHeuristic
{
    public string Name => "Burn Chance Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Burn chance should be relatively static
        if (history.Count > 1)
        {
