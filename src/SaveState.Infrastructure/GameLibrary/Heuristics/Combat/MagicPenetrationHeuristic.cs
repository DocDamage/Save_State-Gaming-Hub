...
/// <summary>
/// Heuristic for detecting magic penetration values in game memory.
/// Magic penetration values typically:
...
/// - Often paired with magical/elemental damage builds
/// </summary>
public sealed class MagicPenetrationHeuristic : IValueHeuristic
{
    public string Name => "Magic Penetration Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Magic penetration should be relatively static
        if (history.Count > 1)
        {
        ...
        // Usually increases with magical gear
