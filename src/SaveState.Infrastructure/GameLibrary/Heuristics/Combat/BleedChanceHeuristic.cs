...
/// <summary>
/// Heuristic for detecting bleed chance values in game memory.
/// Bleed chance values typically:
/// - Are floats in range 0.0-100.0 (percentage)
/// - Static or change with gear/skill upgrades
/// - Often associated with physical/piercing damage
/// - May trigger on critical hits or special attacks
/// </summary>
public sealed class BleedChanceHeuristic : IValueHeuristic
{
    public string Name => "Bleed Chance Detection";
    ...
    public double CalculateConfidence(DiscoveredValue value, List<ValueObservation> history)
    {
        ...
        // Bleed chance should be relatively static
        if (history.Count > 1)
        {
