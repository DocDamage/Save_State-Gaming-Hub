...
/// Tests tournament CRUD, participant registration, bracket generation, and match management.
/// </summary>
public class TournamentManagementIntegrationTests : IClassFixture<IntegrationTestFixture>
{
    private readonly IntegrationTestFixture _fixture;
    private readonly ITournamentService _tournamentService;

    public TournamentManagementIntegrationTests(IntegrationTestFixture fixture)
    {
        _fixture = fixture;
    ...
    [Fact]
    public async Task CreateTournament_ReturnsCreatedTournament()
    {
        // Arrange
    ...
    [Fact]
    public async Task ConcurrentParticipantRegistration_HandlesRaceConditions()
    {
        // Arrange
        var tournamentRequest = TestDataSeeder.CreateSampleTournamentRequest("Concurrent Registration Test");
        tournamentRequest = tournamentRequest with { MaxParticipants = 100 };
        var tournamentResult = await _tournamentService.CreateTournamentAsync(tournamentRequest);
        var tournamentId = tournamentResult.Value.Id;
        ...
        var tasks = Enumerable.Range(0, 10).Select(i =>
        {
            ...
            return _tournamentService.RegisterParticipantAsync(tournamentId, registerRequest);
        });
    ...
    [Fact]
    public async Task CreateTournament_Under100Milliseconds()
    {
        // Arrange
        var request = TestDataSeeder.CreateSampleTournamentRequest("Performance Test");
