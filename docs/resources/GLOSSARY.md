...
| **Ikemen GO** | Open-source fighting game engine compatible with MUGEN resources | Ikemen integration |
...
| **MugenHook** | Engine enhancement adding animated portraits, multiple characters per slot | Character development |
| **LuaSupernull** | Advanced character framework using Lua for stable supernulls | Character development |
| **OpenMK** | Development library for creating Mortal Kombat-style games in Ikemen GO | Character development |
| **Character Pack** | Collection of characters, stages, and resources bundled together | Character management |
| **Character Template** | Starting point/framework for creating new characters | Character creation |
| **Movelist Extraction** | Automatic parsing of character move data from .def files | Character metadata |
